...
export default function AutoTextRoll() {
    ...
    return (
        ...
        <div className="relative h-14 sm:h-20 w-full overflow-hidden flex items-center justify-center">
            <AnimatePresence mode="wait">
                <motion.span
                    ...
                    animate="center"
                    exit="exit"
                    className="absolute text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold uppercase tracking-wider text-center bg-linear-to-r from-[#A1FFCE] to-[#FAFFD1] bg-clip-text text-transparent"
                >
                    {trackingRoles[index]}
                </motion.span>
            </AnimatePresence>
